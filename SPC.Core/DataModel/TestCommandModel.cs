...
namespace SPC.Core.DataModel
{
    public class TestCommandModel
    {
        ...
        //private BitDevices _BitDevices = null;

        private WordDevices _WordDevices = null;
        ...
        public TestCommandModel(BitDevices bitDevices, WordDevices wordDevices, Core core)
        {
            //_BitDevices = bitDevices;
            _WordDevices = wordDevices;
            _Core = core;
        }
